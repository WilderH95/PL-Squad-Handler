...
class DataHandler:
    ...
    def get_pl_squad(self, team_name):
        ...
        self.site_dh = DFHandler(self.opta_ids, self.photo_ids, self.squad_numbers, self.first_names, self.last_names)
    ...
    def read_sheet(self, team):
        ...
        try:
            ...
            self.sheet_dh = DFHandler(self.sh_opta_ids, self.sh_photo_ids, self.sh_squad_numbers, self.sh_first_names,
                                      self.sh_last_names)
