...
datahandler = DataHandler(google_api_key=GOOGLE_API_KEY, opta_user=OPTA_USER, opta_key=OPTA_KEY, season=2025)
...
def index():
    if request.method == 'POST':
        ...
        if team == "-":
            ...
            return render_template('index.html', message=message, squad_urls=dictionaries.teams, new_players = "-")
        else:
    ...
    return render_template('index.html', squad_urls=dictionaries.teams)
